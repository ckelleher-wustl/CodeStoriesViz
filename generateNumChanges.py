# generating csv with number of changes in each line for heatmap 
import difflib
...
from historyHierarchy import get_code_entries 

startTime = 345
endTime = 779
get_code_entries(startTime,endTime)[1]
...
if __name__ == '__main__':
    ...
    df_scriptjs_lastentry.to_csv('before_after_test.csv')
